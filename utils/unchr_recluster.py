...
def main():
    ...
    draft_fa_dict = parse_fasta(args.draft_fasta)
    ...
    ## RE site
    full_link_dict, sorted_ctg_list, RE_site_dict = parse_pickle(draft_fa_dict, args.full_links)
    ...
    print(f'Debugs ctg_group_dict_new {ctg_group_dict_new}')
    print(f'Debugs list_unreassigned_unitigs {list_unreassigned_unitig}')
    write_group_ids_and_sequences(ctg_group_dict_new, list_unreassigned_unitig, draft_fa_dict)
